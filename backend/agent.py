...
class JointRecommendedEvent(BaseModel):
    ...
    date: Optional[str] = Field(description="The date when the event takes place (e.g., 'May 27, 2025'). Required for 'campus_event' type.")
    time: Optional[str] = Field(description="The time when the event takes place (e.g., '10:00 AM'). Required for 'campus_event' type.")
